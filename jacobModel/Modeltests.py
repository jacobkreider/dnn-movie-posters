...
saved_models_folder = '/home/jacob/data/model/saved_models/'
align = 33
my_format = "{:.0%}"
eval_models = True
print_summary = True
...
def main():
    for model_file_name in list_model_files():
        ...
        test_movies['Comedy'] = ["Bienvenue chez les Ch'tis", "Frequently Asked Questions About Time Travel",
                                 "What We Do in the Shadows", "Hollywood Ending", "Whatever Works",
                                 "Liar Liar"]
        ...
        test_movies['Horror'] = ["Dracula 2000", "The Blair Witch Project", "The Others",
                                 "Aliens vs. Predator: Requiem", "Alien: Resurrection"]

        test_movies['Animation'] = ["Paprika",  "Spirited Away", "Zootopia", "Trolls"]

        test_movies['Romance'] = ["Notting Hill", "The Notebook", "Bridget Jones's Diary"]

        test_movies['?'] = ["Pearl Harbor", "Twelve Monkeys", "The Truman Show",
 
                            "The Bourne Identity",  "Primer", "Finding Nemo", "Django Unchained"]
